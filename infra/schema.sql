...
CREATE TABLE IF NOT EXISTS action_receipts (
  ...
  enforcement_mode STRING NOT NULL CHECK (enforcement_mode IN ('shadow', 'enforce')),
  evidence_digest BYTES NOT NULL,
  previous_receipt_hash BYTES NULL,
  receipt_hash BYTES NOT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (tenant_id, receipt_id),
  UNIQUE (tenant_id, request_id),
  INDEX receipts_trace (tenant_id, trace_id),
  INDEX receipts_subject_time (tenant_id, subject_key, created_at DESC)
);
